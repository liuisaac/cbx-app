...
function TransitionA() {
  return (
    ...
    <div id="home" style={{ 
      ...
      <div  className="md:w-5/6 lg:w-4/6 px-5 pb-24 m-auto w-screen h-screen flex object-scale-down">
        <div className="m-auto transitionACbx flex justify-center"  alt="logo">
            <img src={logoCbx} className="inline p-0 h-full" alt="logo" />
        </div>
        ...
        <div className="m-auto transitionAPartners flex justify-center w-3/4"  alt="logo">
            <img src={logoPartners} className="inline p-0 h-full" alt="logo" />
        </div>
      </div>
    </div>
    </div>
